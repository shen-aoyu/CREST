...
#        print('target_pos[target_pos>0]',target_pos[target_pos>0])
#        sys.exit
        # mse loss
...
class Criterion(nn.Module):
    def __init__(self,
        ...
        self.loss_densitys_weight = loss_densitys_weight
    ...
    def loss_objectness(self, pred_obj, target_obj, target_pos):
        ...
        #print('self.obj_loss_f',self.obj_loss_f)
